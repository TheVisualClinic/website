...
export default function HeaderSection() {
  ...
  const sectionContent = {
    ...
    description_en: 'We are happy to provide consultation and ready to assist with all your needs.',
  }
    ...
    <section className='py-8 sm:py-16 bg-[#F9F6F3]'>
      <div className='container'>
        <div className='text-center space-y-2'>
          ...
          <h2 className='text-xl sm:text-3xl font-light mx-auto text-[#483E3B] whitespace-pre-line'>
