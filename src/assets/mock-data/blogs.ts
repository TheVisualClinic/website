export const blogsList = [
  {
    id: 1,
    order: 3,
    title_th: 'โบท็อกซ์: วิธีการทำงานและข้อดี',
    title_en: 'Botox: How It Works and Benefits',
    description_th:
  ...
  },
  {
    id: 2,
    order: 6,
    title_th: 'เดอร์มอลฟิลเลอร์: ทำไมถึงเป็นที่นิยม',
    title_en: 'Dermal Filler: Why It Is Popular',
    description_th:
  ...
  },
  {
    id: 3,
    order: 1,
    title_th: 'คอลลาเจนไบโอสติมูเลเตอร์: เพิ่มความยืดหยุ่นให้ผิว',
    title_en: 'Collagen Biostimulators: Boost Skin Elasticity',
    description_th:
  ...
  },
  {
    id: 4,
    order: 8,
    title_th: 'อัลตราฟอร์เมอร์: ยกกระชับผิวแบบไม่เจ็บ',
    title_en: 'Ultraformer: Non-invasive Skin Lifting',
    description_th:
  ...
  },
  {
    id: 5,
    order: 2,
    title_th: 'เมโสแฟต: ลดไขมันเฉพาะจุด',
    title_en: 'Mesofat: Targeted Fat Reduction',
    description_th:
  ...
  },
  {
    id: 6,
    order: 4,
    title_th: 'HIFU: เทคโนโลยียกกระชับผิว',
    title_en: 'HIFU: Skin Lifting Technology',
    description_th:
  ...
  },
  {
    id: 7,
    order: 5,
    title_th: 'Thermage: การกระชับผิวด้วยพลังงานคลื่นวิทยุ',
    title_en: 'Thermage: Skin Tightening with Radiofrequency',
    description_th:
  ...
  },
  {
    id: 8,
    order: 7,
    title_th: 'PRP Therapy: การฟื้นฟูผิวด้วยพลาสมา',
    title_en: 'PRP Therapy: Skin Rejuvenation with Plasma',
    description_th:
